import type { ChecklistItem, DatePlan } from "@workspace/api-client-react";
...
export const CHECKLIST_ITEMS: Record<number, { label: string; phase: number; person: "seth" | "elana" | "both" }[]> = {
  1: [
