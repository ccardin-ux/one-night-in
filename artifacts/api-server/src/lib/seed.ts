...
const CHECKLIST_ITEMS: Record<number, { label: string; phase: number; person: "seth" | "elana" | "both" }[]> = {
  ...
  9: [
    ...
    { label: "Seth: Prep any slow-cook components first — braise, confit, or sauce base; French cooking rewards patience", phase: 2, person: "seth" },
  ...
  10: [
    ...
    { label: "Seth: Source tahini, pomegranate molasses, sumac, and flatbread", phase: 1, person: "seth" },
    { label: "Seth: Make your dips and sauces ahead — they improve with time; prep all garnishes and flatbread", phase: 2, person: "seth" },
